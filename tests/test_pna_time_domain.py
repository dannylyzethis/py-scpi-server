...
def licensed_pna() -> SCPIInstrument:
    capabilities = PNACapabilities.create(
        "N5222B-EMU", application_options=("E93010B", "E93007B")
    )
    instrument = SCPIInstrument(
        "Virtual N5222B-EMU", "time-domain", pna_capabilities=capabilities
    )
